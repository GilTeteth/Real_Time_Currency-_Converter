...
# # Python Project UMCS DS Currency Converter
...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # Label
        self.intro_label = Label(self, text='UMCS DS Currency Converter', fg='blue', relief=tk.RAISED, borderwidth=3)
        self.intro_label.config(font=('Courier', 15, 'bold'))

        self.date_label = Label(self,
                                text=f"1 Polish Zloty equals = {self.currency_converter.convert('PLN', 'USD', 1)} USD \n Date : {self.currency_converter.data['date']}",
